...
export default function Contact({ openModal }: ContactProps) {
    ...
    return (
        <section
            ...
            style={{
                backgroundImage: "linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.35)), url('https://images.unsplash.com/photo-1487537708572-3c850b5e856e?dpr=1&auto=compress&format&fit=crop&w=1199&h=798&q=80&cs=tinysrgb&crop=&bg=')"
            }}
        >
