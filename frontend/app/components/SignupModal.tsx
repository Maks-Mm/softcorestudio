...
interface SignupModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;  // Add these
  onError?: () => void;    // Add these
}
...
const SignupModal: React.FC<SignupModalProps> = ({ isOpen, onClose, onSuccess, onError }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onError) onError(); // Call error callback on exception
    } finally {
